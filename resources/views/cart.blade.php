        ...
        <div class="container" >
            <div class="row">
                ...
                {{-- <form action="{{url('cart')}}" method="post">
                        ...
                        value="{{$data->customerid}}" style="border:none; background:none;">


                        <input type="text" name="customername"
                        value="{{ $data->firstname  }}" style="border:none; background:none;">

                       

                        <input type="text" name="quantity" id="quantity"
                        value="{{$totalquantity}}" style="border:none; background:none;">

                        <input type="text" name="price" id="price"
                        value="{{$report}}" style="border:none; background:none;">
                ...
                <a href="{{ url('order/' . $data->id) }}" id="basket" class="btn btn-success">
                    basket({{ $list }}) </a>
                            ...
                            <tbody>
                                ...
                                @foreach ($user as $i)
                                    <tr>
                                        ...
                                        <td style="text-transform: capitalize">
                                            <input type="text" name="productprice" value="{{ $i->productprice }}"
                                                style="border:none; background:none;">
                                        </td>
                                        <td style="text-transform: capitalize">
                                            <input type="text" name="quantity" id=""
                                                value="{{ $i->quantity }}" style="border:none; background:none;">
                                        </td>

                                        <td style="text-transform: capitalize">
                                            <input type="text" name="total" id=""
                                                value="{{ $i->price }}" style="border:none; background:none;">
                            ...
                            <div class="card"
                                ...
                                <div style="display: flex">
                                    <form action="{{ route('menus.store') }}" method="POST"
                                        ...
                                        <button type="submit" class="btn btn-success" style="margin-left: 45px"> Add to
                                            Cart</button>
